...
class DataPoint(BaseDataPoint):
    def get_unconfigured_config(self):
        return {
            'type':'draftfcbforums1',
            'sub_type':'draftfcbforums1',
            'display_name_short':'Forums',
            'full_display_name':'Draft FCB Forum Data',
            'instructions':'Use this data point to search forums collected from Sysomos.',
    ...
    def generate_configured_guid(self, config):
        base_string = 'draftfcbforums1_source'
