...
class DataPoint(BaseDataPoint):
    def get_unconfigured_config(self):
        return {
            'type':'draftfcbnews1',
            'sub_type':'draftfcbnews1',
            'display_name_short':'News',
            'full_display_name':'Draft FCB News Data',
            'instructions':'Use this data point to search news collected from Sysomos.',
            'image_large':'/static/images/thedashboard/data_points/news_large.png',
            'image_medium':'/static/images/thedashboard/data_points/news_medium.png',
            'image_small':'/static/images/thedashboard/data_points/news_small.png',
            'configured':True,
            'elements':[
    ...
    def generate_configured_guid(self, config):
        base_string = 'draftfcbnews1_source'
